namespace NHibernate.Test.Hql.Ast
{
    public class Address
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (Street != null && otherAddress.Street != null && !otherAddress.Street.Equals(Street))
            {
                return false;
            }
            ...
            if (City != null && otherAddress.City != null && !otherAddress.City.Equals(City))
            {
                return false;
            }
            ...
            if (PostalCode != null && otherAddress.PostalCode != null && !otherAddress.PostalCode.Equals(PostalCode))
            {
                return false;
            }
            ...
            if (Country != null && otherAddress.Country != null && !otherAddress.Country.Equals(Country))
            {
                return false;
            }
